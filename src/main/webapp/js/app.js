...
function IndexController($scope, BookService) {
...
function EditController($scope, $routeParams, $location, BookService) {
...
function CreateController($scope, $location, BookService) {
